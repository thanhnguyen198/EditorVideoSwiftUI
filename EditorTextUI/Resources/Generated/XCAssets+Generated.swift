...
internal enum Assets {
    internal static let _4k = SwiftUI.Image("4k")
    internal static let _4k_uiImage = UIImage(named: "4k")!
    internal static let accentColor = ColorAsset(name: "AccentColor").color
    internal static let test = SwiftUI.Image("test")
    internal static let test_uiImage = UIImage(named: "test")!
}
